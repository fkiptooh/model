...
server.post("/hospitals/", function(req, res, next) {
...
function validateHospital(hospital) {
  if (!hospital.name) return "Name is required.";
  if (!hospital.levelId) return "Level is required.";
  if (!hospital.category) return "Category is required.";
  return "";
}
